...
template<class T, class U> SharedPtr<T> const_hyptr_cast(SharedPtr<U>&& r) { return const_vpointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> dynamic_hyptr_cast(const SharedPtr<U>& r) { return dynamic_vpointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> dynamic_hyptr_cast(SharedPtr<U>&& r) { return dynamic_vpointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> reinterpret_hyptr_cast(const SharedPtr<U>& r) { return reinterpret_vpointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> reinterpret_hyptr_cast(SharedPtr<U>&& r) { return reinterpret_vpointer_cast<T,U>(r); }
...
template<class T, class U> SharedPtr<T> static_hyptr_cast(const SharedPtr<U>& r) { return static_pointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> static_hyptr_cast(SharedPtr<U>&& r) { return static_pointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> const_hyptr_cast(const SharedPtr<U>& r) { return const_pointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> const_hyptr_cast(SharedPtr<U>&& r) { return const_pointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> dynamic_hyptr_cast(const SharedPtr<U>& r) { return dynamic_pointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> dynamic_hyptr_cast(SharedPtr<U>&& r) { return dynamic_pointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> reinterpret_hyptr_cast(const SharedPtr<U>& r) { return reinterpret_pointer_cast<T,U>(r); }
template<class T, class U> SharedPtr<T> reinterpret_hyptr_cast(SharedPtr<U>&& r) { return reinterpret_pointer_cast<T,U>(r); }
