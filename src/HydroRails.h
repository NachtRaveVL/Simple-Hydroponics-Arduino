...
class HydroRail : public HydroObject, public HydroRailObjectInterface {
public:
    ...
    Signal<HydroRail *, HYDRO_CAPACITY_STATE_SLOTS> &getCapacitySignal();
...
protected:
    ...
    Signal<HydroRail *, HYDRO_CAPACITY_STATE_SLOTS> _capacitySignal; // Capacity changed signal
