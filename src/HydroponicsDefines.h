...
#define HYDRUINO_BAL_DECACTUATORS_MAXSIZE   2                       // Maximum array size for balancer decrement actuators list (max # of decrement autodosers/actuators used during balancing)
...
#define HYDRUINO_SCH_FEEDRES_MAXSIZE        2                       // Maximum array size for scheduler feeding/lighting process lists (max # of feed reservoirs)
#define HYDRUINO_SYS_ONEWIRE_MAXSIZE        2                       // Maximum array size for pin->OneWire instances list (max # of OneWire comm pins)
#define HYDRUINO_SYS_PINLOCKS_MAXSIZE       2                       // Maximum array size for pin locks list (max # of simultaneous locks)
...
#define HYDRUINO_SYS_ENABLE_DRY_RUN         false                   // Disables actuators from actually enabling in order to simulate (mainly used for debugging)
