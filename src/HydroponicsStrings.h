...
extern const PROGMEM char HS_Key_CO2SensorName[];
...
extern const PROGMEM char HS_Key_MoistureSensorName[];
...
extern const PROGMEM char HS_Key_OutputReservoirName[];
extern const PROGMEM char HS_Key_PHRange[];
extern const PROGMEM char HS_Key_PHSensorName[];
...
extern const PROGMEM char HS_Key_PowerSensorName[];
...
extern const PROGMEM char HS_Key_TDSSensorName[];
extern const PROGMEM char HS_Key_TDSUnits[];
extern const PROGMEM char HS_Key_TempSensorName[];
